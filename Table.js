...
var inic=(Math.round(((Math.random())*100))%4);//valor inicial para las casillas

boton.style.backgroundColor=colores[inic];

var celda_color=[inic,inic,inic,inic,inic,inic,inic,inic,inic];//indica el color del cuadro. 0=azul,1=verde,2=rojo,3=amarillo

var coloreado=[0,0,0,0,0,0,0,0,0]//evita el bug de ganar sin completar el cuadro
...
function escribir(){//escribe el tiempo en el cronometro
    ...
    if(m==5&&s==0){//se coloca el limite de tiempo para resolver el juego
        ...
        parar();
        Sonido(1,0.6);
        alert("QUE LENTO!!!!!!, PERDISTE!!!, GAME OVER ^W^. "+"PUNTAJE: "+(score[0]/2-score[1]-m*60-s));
        ...
        if(timeout){
            ...
            parar();
            Sonido(3,3);
            alert("QUE CRACK!!! HAS GANADO "+"PUNTAJE: "+(score[0]-score[1]-m*60-s));
